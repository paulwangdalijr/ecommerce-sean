...
/***/ "./src/app/product.module/components/cart/cart.component.css":
/*!*******************************************************************!*\
  !*** ./src/app/product.module/components/cart/cart.component.css ***!
  \*******************************************************************/
/*! no static exports found */
...
/***/ "./src/app/product.module/components/cart/cart.component.html":
/*!********************************************************************!*\
  !*** ./src/app/product.module/components/cart/cart.component.html ***!
  \********************************************************************/
/*! no static exports found */
...
var CartComponent = /** @class */ (function () {
    function CartComponent(productService, cartService, authService) {
    ...
    CartComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'app-cart',
            template: __webpack_require__(/*! ./cart.component.html */ "./src/app/product.module/components/cart/cart.component.html"),
            styles: [__webpack_require__(/*! ./cart.component.css */ "./src/app/product.module/components/cart/cart.component.css")]
        }),
...
/***/ "./src/app/product.module/components/checkout/checkout.component.css":
/*!***************************************************************************!*\
  !*** ./src/app/product.module/components/checkout/checkout.component.css ***!
  \***************************************************************************/
/*! no static exports found */
...
/***/ "./src/app/product.module/components/checkout/checkout.component.html":
/*!****************************************************************************!*\
  !*** ./src/app/product.module/components/checkout/checkout.component.html ***!
  \****************************************************************************/
/*! no static exports found */
...
/***/ "./src/app/product.module/components/checkout/checkout.component.ts":
/*!**************************************************************************!*\
  !*** ./src/app/product.module/components/checkout/checkout.component.ts ***!
  \**************************************************************************/
...
var CheckoutComponent = /** @class */ (function () {
    ...
    CheckoutComponent.prototype.onCreateOrderClick = function () {
        ...
        this.cartService.getCart();
        if (this.authService.loggedIn()) {
            this.authService.createOrder(user, this.cartService.cart).subscribe(function (data) {
                if (data.success) {
...
/***/ "./src/app/product.module/components/payment/payment.component.css":
/*!*************************************************************************!*\
  !*** ./src/app/product.module/components/payment/payment.component.css ***!
  \*************************************************************************/
/*! no static exports found */
...
/***/ "./src/app/product.module/components/payment/payment.component.html":
/*!**************************************************************************!*\
  !*** ./src/app/product.module/components/payment/payment.component.html ***!
  \**************************************************************************/
/*! no static exports found */
...
/***/ "./src/app/product.module/components/payment/payment.component.ts":
/*!************************************************************************!*\
  !*** ./src/app/product.module/components/payment/payment.component.ts ***!
  \************************************************************************/
...
var PaymentComponent = /** @class */ (function () {
    ...
    PaymentComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            ...
            template: __webpack_require__(/*! ./payment.component.html */ "./src/app/product.module/components/payment/payment.component.html"),
            styles: [__webpack_require__(/*! ./payment.component.css */ "./src/app/product.module/components/payment/payment.component.css")]
        }),
...
/***/ "./src/app/product.module/components/product-list/product-list.component.css":
/*!***********************************************************************************!*\
  !*** ./src/app/product.module/components/product-list/product-list.component.css ***!
  \***********************************************************************************/
/*! no static exports found */
...
module.exports = ".list-item-3 {\r\n\tmargin-right: 20px;\r\n}\r\n.list-item-4 {\r\n\tmargin-right: 0px\r\n}\r\n.submenu{\r\n\tpadding-bottom: 10px;\r\n}\r\n.card-body {\r\n\theight: 20em;\r\n}\r\n.card-subtitle{\r\n\toverflow: hidden;\r\n  text-overflow: ellipsis;\r\n\t\r\n}\r\n#properties-list-group{\r\n\twidth: 100%;\r\n}\r\n.fas.fa-shopping-cart{\r\n    font-size: 30px;\r\n    margin-left: 15px;\r\n}\r\n.card-body img,.modal img {\r\n\theight: auto;\r\n\tmin-height: 10em;\r\n\tmax-height: 10em;\r\n\tmax-width: 100%;\r\n\twidth: 100%;\r\n}\r\n.add-to-cart{\r\n\theight: auto;\r\n\tmax-width: 100%;\r\n\tfont-size: 80%;\r\n}\r\n.card-col{\r\n\tmin-width: 15em;\r\n}\r\n\r\n"

/***/ }),

/***/ "./src/app/product.module/components/product-list/product-list.component.html":
/*!************************************************************************************!*\
  !*** ./src/app/product.module/components/product-list/product-list.component.html ***!
  \************************************************************************************/
/*! no static exports found */
...
/***/ "./src/app/product.module/components/product-list/product-list.component.ts":
/*!**********************************************************************************!*\
  !*** ./src/app/product.module/components/product-list/product-list.component.ts ***!
  \**********************************************************************************/
...
var ProductListComponent = /** @class */ (function () {
    function ProductListComponent(cartService, productService, authService) {
        this.cartService = cartService;
        this.productService = productService;
        this.authService = authService;
    ...
    ProductListComponent.prototype.onChangeCheckBox = function (checked, category) {
        var _this = this;
        if (checked) {
            ...
            var i = this.selectedCategories.findIndex(function (obj) { return obj.id === category.ID; });
            this.selectedCategories.splice(i, 1);
        }
        this.products.forEach(function (product) {
            var flag = false;
            product.categories.forEach(function (cat) {
                if (_this.selectedCategories.findIndex(function (obj) { return obj.id === cat; }) >= 0) {
                    flag = true;
                }
                // else{
                //   product.show = false;
    ...
    ProductListComponent.prototype.filterByCategory = function (categories) {
        ...
        categories.forEach(function (elem) {
            if (_this.selectedCategories.includes(elem)) {
                return true;
            }
            else {
                return false;
...
/***/ "./src/app/product.module/product-routing.module.ts":
/*!**********************************************************!*\
  !*** ./src/app/product.module/product-routing.module.ts ***!
  \**********************************************************/
...
/***/ "./src/app/product.module/product.component.ts":
/*!*****************************************************!*\
  !*** ./src/app/product.module/product.component.ts ***!
  \*****************************************************/
...
/* harmony import */ var _components_product_list_product_list_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./components/product-list/product-list.component */ "./src/app/product.module/components/product-list/product-list.component.ts");
/* harmony import */ var _product_routing_module__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! .//product-routing.module */ "./src/app/product.module/product-routing.module.ts");
/* harmony import */ var _product_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./product.component */ "./src/app/product.module/product.component.ts");
...
/***/ "./src/app/product.module/services/cart.service.ts":
/*!*********************************************************!*\
  !*** ./src/app/product.module/services/cart.service.ts ***!
  \*********************************************************/
...
var CartService = /** @class */ (function () {
    function CartService(authService) {
        this.authService = authService;
        this.cart = [];
    }
