(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["admin-module-admin-module~product-module-product-module"],{
...
var ProductService = /** @class */ (function () {
    function ProductService(http, authService) {
        ...
        this.fileUploader = new ng2_file_upload__WEBPACK_IMPORTED_MODULE_3__["FileUploader"]({ url: this.domain + '/auth/imageUpload'
        });
    ...
    ProductService.prototype.uploadFile = function (id, cb) {
    ...
    ProductService.prototype.getAllOrders = function () {
        this.authService.createAuthenticationHeaders();
...
//# sourceMappingURL=admin-module-admin-module~product-module-product-module.js.map